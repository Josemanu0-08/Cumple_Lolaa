...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `(Antes de leer pulsa abajo donde la m´sica)
    Feliz cumpleaños ❤️🎉🥳
...
Ojalá pronto llegue el día en el q pueda verte, abrazarte y celebrar juntos, porque para mí no hay regalo más grande q tenerte en mi viday haberte conocido. 💕❤️`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con mucho cariño, José Manuel (Tu futuro boyfriend)❤️😘";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-09-09T00:00:00'); 
  ...
  function update() {
    ...
    container.innerHTML =
      `Llevamos juntos: </b> 0 días, AJAJAJAJA<br>` +
      `Nuestro aniversario: </b> QUIEN SABE, OJALÁ PRONTO`;
